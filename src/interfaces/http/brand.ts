...
import { HypothesesGenerationResult, HypothesesGenerationServiceImpl } from '@features/brand_analysis/hypotheses-generation';
...
export async function brandRoutes(fastify: FastifyInstance) {
    ...
    fastify.get<{
        ...
        Reply: HypothesesGenerationResult;
    }>('/brand', {
        ...
        try {
            ...
            const generator = new HypothesesGenerationServiceImpl();
            const result = await generator.generateHypotheses(shopDomain);
